...
const PortfolioSection: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="">
        <div
          className="flex overflow-x-auto gap-3 mb-10 px-1 scrollbar-hide"
          data-aos="fade-up"
        >
          {categories.map((cat) => (
            <button
        ...
        <div className="grid grid-cols-1 gap-8 md:gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filteredItems.map((item, index) => (
            ...
            >
              ...
              <span className="absolute px-3 py-1 text-xs font-medium text-white uppercase bg-orangecustom rounded-full shadow-md top-3 left-3">
                {item.category}
              </span>
