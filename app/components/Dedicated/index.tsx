      ...
      <div className="px-4 mx-auto my-20 max-w-7xl sm:py-20 lg:px-8">
        <div className="relative">
          ...
          <div className="relative pt-[40px] md:pt-[80px] flex flex-col gap-12">
            <p className="flex items-center gap-2 md:gap-7 justify-end text-end text-[19px] md:text-[30px] font-medium text-orangecustom">
              <Image
            ...
            <p className="flex items-center gap-2 md:gap-7 justify-start text-start text-[20px] md:text-[30px] font-medium text-orangecustom">
            ...
            <p className="flex items-center gap-1 md:gap-7 justify-end text-end text-[20px] md:text-[30px] font-medium text-orangecustom">
              <Image
                src="/images/dedicated/failed.svg"
                alt="gagal"
                width={33}
            ...
            <p className="flex items-center gap-3 md:gap-7 justify-start text-start text-[20px] md:text-[30px] font-medium text-orangecustom">
          ...
          <div className="relative pt-[40px] md:pt-[80px] flex flex-col gap-10">
            <p className="flex items-center gap-3 md:gap-7 justify-end text-end text-[20px] md:text-[30px] font-medium text-solutiongreen">
              <Image
            ...
            <p className="flex items-center gap-3 md:gap-7 justify-start text-start text-[20px] md:text-[30px] font-medium text-solutiongreen">
